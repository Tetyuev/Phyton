...
while True:
    ...
    aff=input('Введите форму собственности:\n')
...
f_profit={}
avr_profit=[]
with open("Task_5_7.txt", 'r', encoding='utf-8') as a:
    for line in a:
        profit=float(line.split()[2])-float(line.split()[3])
        f_profit[line.split()[0]]=profit
        if profit>0:
            avr_profit.append(profit)
from functools import reduce
avg = reduce(lambda x, y: x + y, avr_profit)/len(avr_profit)
fin_l=[f_profit, {'Средняя прибыль':avg}]
print(fin_l)
import json
with open("Task_5_7.json", "w") as f_f:
    json.dump(fin_l, f_f)
